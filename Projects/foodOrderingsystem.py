...
def main():
    ...
    while True:
        ...
        if choice == "1":
            ...
            #apply coupon
            couponIntput = input("Enter coupon code (or press Enter to skip): ").strip()
            discount, couponUsed = apply_coupon(subtotal, couponIntput)
            ...
            if confirm == "y":
                ...
                print("Order cancelled. You can continue modifying the cart.")
